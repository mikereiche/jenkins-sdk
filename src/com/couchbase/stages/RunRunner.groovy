    ...
    void executeImpl(StageContext ctx) {
        ...
        ctx.inSourceDir {
            ...
            ctx.env.dir("/sdk-driver", {
                ctx.env.executeSimple("DOCKER_HOST=172.23.104.43:2376 docker run --rm --network perf -v " + stageOutput.absoluteConfigFilename() + ":/testSuite.yaml driver /testSuite.yaml")
            })
        }
    }
}