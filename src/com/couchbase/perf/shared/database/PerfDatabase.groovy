...
class PerfDatabase {
    ...
    static void migrate(StageContext ctx, String[] args) {
        ...
        execute(sql, ctx, "CREATE TABLE IF NOT EXISTS buckets (time TIMESTAMPTZ NOT NULL, time_offset_secs bigint, run_id uuid, operations_total int, operations_success int, operations_failed int, duration_min_us int, duration_max_us int, duration_average_us int, duration_p50_us int, duration_p95_us int, duration_p99_us int, errors jsonb)")
